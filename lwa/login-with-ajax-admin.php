...
class LoginWithAjaxAdmin {
  ...
  function menus() {
    $page = add_submenu_page( 'florp-main', 'Login With Ajax', 'Login With Ajax', 'manage_options', 'florp-lwa', array( &$this, 'options' ) );
        ...
        <div class="updated notice notice-success is-dismissible password_link">
            <p>
              <?php echo esc_html_e( "Since WordPress 4.3 passwords are not emailed to users anymore, they're replaced with a link to create a new password.", 'login-with-ajax' ); ?>
                <a href="<?php echo admin_url( 'admin.php?page=florp-lwa' ); ?>"><?php echo esc_html_e( "Check your registration email template.", 'login-with-ajax' ); ?></a>
            </p>
  ...
  function options_head() {
    ?>
      <style type="text/css">
          ...
          .nwl-plugin table .col {
              width: 100px;
          }

          .nwl-plugin table input.wide {
              width: 100%;
              padding: 2px;
          }
                      ...
                      <form method="post" action="">
                          ...
                          <table class="form-table">
                            ...
                            <?php endif; ?>
                              <tr valign="top">
                                  ...
                                  <td>
                                      <input style="margin:0px; padding:0px; width:auto;" type="checkbox" name="lwa_no_login_refresh" value='1'
                                             class='wide' <?php echo ( !empty( $lwa_data['no_login_refresh'] ) && $lwa_data['no_login_refresh'] == '1' ) ? 'checked="checked"' : ''; ?> />
                                      <br/>
                                            ...
                                            <table id="lwa_<?php echo $name; ?>_langs">
                                              ...
                                              foreach ($langs as $lang) {
                                                if (substr( get_locale(), 0, 2 ) != $lang['language_code']) {
                                                  $strLangName = $lang['translated_name'];
                                                  if (empty( $strLangName )) {
                                                    $strLangName = $lang['native_name'];
                                                  }
                                                  ?>
                                                    <tr>
                                                        <th style="width:100px;"><?php echo $strLangName; ?>:</th>
                                                        <td><input type="text" name="lwa_<?php echo $name; ?>_<?php echo $lang['language_code']; ?>"
                                                                   value='<?php echo ( !empty( $lwa_data[$name . '_' . $lang['language_code']] ) ) ? $lwa_data[$name . '_' . $lang['language_code']] : ''; ?>'
                                                                   class="wide"/></td>
                                                    </tr>
                                                  <?php
                                                }
                                                  ...
                                                  foreach ($langs as $lang) {
                                                    if (substr( get_locale(), 0, 2 ) != $lang['language_code']) {
                                                      ...
                                                      ?>
                                                        <tr>
                                                            <th style="width:100px;"><?php echo $strLangName; ?>:</th>
                                                            <td><input type="text" name="lwa_<?php echo $name; ?>_<?php echo $role ?>_<?php echo $lang['language_code']; ?>"
                                                                       value='<?php echo ( !empty( $lwa_data[$name][$role . '_' . $lang['language_code']] ) ) ? $lwa_data[$name][$role . '_' . $lang['language_code']] : ''; ?>'
                                                                       class="wide"/></td>
                                                        </tr>
                                                      <?php
                                                    }
                          ...
                          <table class="form-table">
                              <tr valign="top">
                                  ...
                                  <td>
                                      <input style="margin:0px; padding:0px; width:auto;" type="checkbox" name="lwa_notification_override" value='1'
                                             class='wide' <?php echo ( !empty( $lwa_data['notification_override'] ) && $lwa_data['notification_override'] == '1' ) ? 'checked="checked"' : ''; ?> />
                                  </td>
                              </tr>
                              <tr valign="top">
                                  <th>
                                  ...
                                  <td>
                                    ...
                                    ?>
                                      <input type="text" name="lwa_notification_subject" value='<?php echo ( !empty( $lwa_data['notification_subject'] ) ) ? $lwa_data['notification_subject'] : ''; ?>'
                                             class='wide'/>
