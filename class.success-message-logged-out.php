 ...
 */
final class NF_Actions_SuccessMessageLoggedOut extends NF_Abstracts_Action {
  /**
   * @var string
   */
  protected $_name = 'success-message-logged-out';
  ...
  public function __construct() {
    ...
    $this->_nicename = __( 'Success Message (Logged Out)', 'ninja-forms' );
