 ...
 */
final class NF_Actions_SuccessMessageLoggedIn extends NF_Abstracts_Action {
  /**
   * @var string
   */
  protected $_name = 'success-message-logged-in';
  ...
  public function __construct() {
    ...
    $this->_nicename = __( 'Success Message (Logged In)', 'ninja-forms' );
