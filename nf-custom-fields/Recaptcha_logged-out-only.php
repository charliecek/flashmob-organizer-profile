...
/**
 * Class NF_Fields_RecaptchaLoggedOutOnly
 */
class NF_Fields_RecaptchaLoggedOutOnly extends NF_Abstracts_Field
{
    protected $_name = 'recaptcha_logged-out-only';

    protected $_type = 'recaptcha_logged-out-only';
    ...
    public function __construct() {
        ...
        $this->_nicename = __( 'Recaptcha (logged out only)', 'ninja-forms' );
