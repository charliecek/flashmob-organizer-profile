...
- new options:
  - profile form (ninja form)
  - popup (PUM)
- check if handling the profile/registration form in hooks, JS
- dynamic changes to profile form (some fields hidden / shown if saving profile / registering)
- options page on flashmob blog only
- new NF actions:
